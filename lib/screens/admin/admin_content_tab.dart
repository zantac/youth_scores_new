...
/// Content tab — mirrors the website's /admin/content: News and Venues. Ads
/// moved to their own top-level tab (see AdminAdsTab).
    ...
    return DefaultTabController(
      ...
      child: Column(
        children: [
          ...
          const Expanded(
            child: TabBarView(
              children: [_NewsSection(), _VenuesSection()],
            ),
          ),
        ],
      ),
